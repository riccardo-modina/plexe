...
bin/plexe_run: src/scripts/plexe_run.in.py out/config.py
...
doxy:
	PLEXE_VERSION=$(shell doc/version.sh) doxygen doxy.cfg

doxyshow: doxy
	xdg-open doc/doxy/index.html

formatting:
	bin/plexe_format_code src
	bin/plexe_format_code subprojects
